...
v1.0.146 已同步GitHub、发布GHCR并部署Ubuntu，应用发布提交 `173ed6f362178becfbfdbaed15d90d932e4e72d6`。Linux回归654项通过，正式公网、本机、鉴权、页面交互与业务数据复核通过，未回退。最终证据与恢复边界见 `docs/RELEASE_REVIEW_v1.0.146.md`，其状态优先于历史日志。
