...
v1.0.147 已同步GitHub、发布GHCR并部署Ubuntu，应用发布提交 `2c78e3bec71b7b17ed8bbdffcebf3acb40eb5c57`（PR #25）。Linux回归731项通过；修复大库预览慢、经代表末尾合计被误判及上传请求无限等待，四份日常清单已通过共用服务成功导入，记录291—294。最新复核与浏览器自动选文件限制见 `docs/RELEASE_REVIEW_v1.0.147.md`，其状态优先于历史日志。2025年既有0.01万元汇总差异未扩大，不视作本轮新增问题。
