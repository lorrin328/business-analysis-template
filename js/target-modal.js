// target-modal.js — target setting modal and target data lifecycle
    ...
    function populateDashboardYearSelects() {
      [['yearSelect', selectedYear], ['rangeYearSelect', selectedYear], ['payPeriodYearSelect', payPeriodFilters?.year], ['payPeriodAverageYearSelect', payPeriodFilters?.year], ['teamYearSelect', selectedTeamYear]]
        .forEach(([id, selected]) => {
