...
ensure_env_value ANTHROPIC_MODEL 'deepseek-v4-flash-vision-exp'
ensure_env_value ANTHROPIC_DEFAULT_OPUS_MODEL 'deepseek-v4-flash-vision-exp'
ensure_env_value ANTHROPIC_DEFAULT_SONNET_MODEL 'deepseek-v4-flash-vision-exp'
ensure_env_value ANTHROPIC_DEFAULT_HAIKU_MODEL 'deepseek-v4-flash-vision-exp'
ensure_env_value CLAUDE_CODE_SUBAGENT_MODEL 'deepseek-v4-flash-vision-exp'
ensure_env_value MARKET_ANALYSIS_MODEL 'deepseek-v4-flash-vision-exp'
ensure_env_value MARKET_ANALYSIS_PRIMARY_MODEL 'deepseek-v4-flash-vision-exp'
ensure_env_value MARKET_ANALYSIS_REPAIR_MODEL 'deepseek-v4-flash-vision-exp'
ensure_env_value MARKET_ANALYSIS_ESCALATION_MODEL 'deepseek-v4-flash-vision-exp'
ensure_env_value MARKET_ANALYSIS_SOURCE_SCOUT_ENABLED '1'
ensure_env_value MARKET_ANALYSIS_SOURCE_SCOUT_MODEL 'deepseek-v4-flash-vision-exp'
