...
def test_frontend_centralizes_read_api_fetches():
    ...
    assert '<script src="js/month-multi-select.js?v=1.0.114"></script>' in html
    assert '<script src="js/api-client.js?v=1.0.114"></script>' in html
    assert '<script src="js/auth-ui.js?v=1.0.114"></script>' in html
    assert '<script src="js/export-excel.js?v=1.0.114"></script>' in html
    assert '<script src="js/upload.js?v=1.0.114"></script>' in html
    assert '<script src="js/target-modal.js?v=1.0.114"></script>' in html
    assert '<script src="js/kpi-cards.js?v=1.0.114"></script>' in html
    assert '<script src="js/platform-trend.js?v=1.0.114"></script>' in html
    assert '<script src="js/team-analysis.js?v=1.0.114"></script>' in html
...
def test_dashboard_config_is_loaded_before_kpi_cards():
    ...
    assert '<script src="js/dashboard-config.js?v=1.0.114"></script>' in html
...
def test_product_config_modal_is_outside_html_shell():
    ...
    assert '<script src="js/product-config-modal.js?v=1.0.114"></script>' in html
...
def test_dashboard_toolbar_actions_are_bound_by_runtime_module():
    ...
    assert '<script src="js/dashboard-actions.js?v=1.0.114"></script>' in html
...
def test_kpi_modal_content_is_outside_html_shell():
    ...
    assert '<script src="js/kpi-modal-content.js?v=1.0.114"></script>' in html
...
def test_org_analysis_has_expand_mode_and_colored_indicators():
    ...
    assert 'src="js/org-analysis.js?v=1.0.114"' in html
...
def test_kpi_cards_js_is_runtime_owner_for_kpi_cards():
    ...
    assert 'src="js/kpi-cards.js?v=1.0.114"' in html
...
def test_platform_trend_main_is_loaded_at_runtime_boundary():
    ...
    assert '<script src="js/platform-trend-main.js?v=1.0.114"></script>' in html
