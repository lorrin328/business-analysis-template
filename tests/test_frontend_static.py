...
def test_frontend_centralizes_read_api_fetches():
    ...
    assert '<script src="js/api-client.js?v=1.0.85"></script>' in html
    assert '<script src="js/auth-ui.js?v=1.0.85"></script>' in html
    assert '<script src="js/export-excel.js"></script>' in html
    assert '<script src="js/upload.js?v=1.0.85"></script>' in html
    ...
    assert '<script src="js/team-analysis.js?v=1.0.85"></script>' in html
...
def test_honor_page_is_separate_runtime():
    ...
    assert '<script src="/js/honor.js?v=1.0.85"></script>' in honor_html
...
def test_platform_trend_main_is_loaded_at_runtime_boundary():
    ...
    assert '<script src="js/platform-trend-main.js?v=1.0.85"></script>' in html
