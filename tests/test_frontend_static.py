...
def test_frontend_centralizes_read_api_fetches():
    ...
    assert '<script src="js/api-client.js?v=1.0.88"></script>' in html
    assert '<script src="js/auth-ui.js?v=1.0.88"></script>' in html
    assert '<script src="js/export-excel.js"></script>' in html
    assert '<script src="js/upload.js?v=1.0.88"></script>' in html
    ...
    assert '<script src="js/team-analysis.js?v=1.0.88"></script>' in html
...
def test_product_config_modal_is_outside_html_shell():
    ...
    assert '<script src="js/product-config-modal.js?v=1.0.88"></script>' in html
...
def test_honor_page_is_separate_runtime():
    ...
    assert '<script src="/js/honor.js?v=1.0.88"></script>' in honor_html
    ...
    assert "personSearch" in honor_js
    assert "renderExceptions" in honor_js
    assert "人均钻石" in honor_js
    assert "renderFilterBar" in honor_js
...
def test_platform_trend_main_is_loaded_at_runtime_boundary():
    ...
    assert '<script src="js/platform-trend-main.js?v=1.0.88"></script>' in html
